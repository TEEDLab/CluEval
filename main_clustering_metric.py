#################################
# Code set to evaluate input and output clustering for author name disambiguation in Python 3
# This code set has been developed under an NSF grant: XXX
#
# 
##################################


# NOTE: Run this script with 'cluster_evaluation.py' in the same directory
